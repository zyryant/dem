...
<section class="section admin">
  <div class="container">
    ...
    <div class="admin-layout">
      ...
      <!-- Левый столбец: фильтры и поиск -->
      <aside class="admin-sidebar-filters reveal">
        <form class="admin-filters-vert" method="get">
          <span class="admin-sidebar-title">Поиск и фильтры</span>
          ...
          <a href="admin.php" class="btn btn-ghost btn-block">Сбросить</a>
        </form>
      </aside>
